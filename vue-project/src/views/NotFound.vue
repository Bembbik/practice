...
export default {
  ...
  methods: {
    goHome() {
      ...
      // Словарь соответствий между ролями и маршрутами
      const roleToRouteMap = {
        ADMIN: '/admin',
        DEPARTMENT: '/department',
        TEAMLEAD: '/team-lead',
        TEAM_MEMBER: '/team/tickets',
      }

      // Определяем маршрут по роли или используем маршрут для "Сотрудник" по умолчанию
      const homePath = roleToRouteMap[userRole] || '/team/tickets'
